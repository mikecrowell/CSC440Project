<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reports.aspx.cs" MasterPageFile="~/Site.master" Inherits="DigitalAssetManagementSep28.AdminPages.Reports" %>
...
<asp:Content ID="displayContent" ContentPlaceHolderID="mainContent" runat="server">
    ...
    <div style="padding-left:10em;"> 
        ...
        <asp:Panel ID="Panel1" runat="server" style="display:block;">
            <p style="font-weight:bold;">User Activity Report</p>
            <br />
        ...
        <asp:Panel ID="Panel2" runat="server" style="display:none;">
            <p style="font-weight:bold;">File Download Report</p>
            <br />
